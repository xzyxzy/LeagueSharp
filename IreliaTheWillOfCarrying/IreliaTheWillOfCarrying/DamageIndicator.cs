    ...
    class DamageIndicator
    {
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            ...
            foreach (var unit in ObjectManager.Get<Obj_AI_Hero>().Where(h => h.IsValid && h.IsHPBarRendered && h.IsEnemy))
            {
                ...
                if (ObjectManager.Player.HealthPercentage() < unit.HealthPercentage() && Irelia.E.IsReady())
                    Drawing.DrawText(Drawing.WorldToScreen(unit.Position)[0] - 20, Drawing.WorldToScreen(unit.Position)[1] - 30, Color.White, "Stunnable");
